...
var aufgabe5_blumenwiese;
(function (aufgabe5_blumenwiese) {
    ...
    let flowersize = 16;
    let backgroundImage;
    //Arrays f�r Position der Bienen
    let x = [];
    let y = [];
    let n = 10; //10 Bienen
    function init() {
...
})(aufgabe5_blumenwiese || (aufgabe5_blumenwiese = {}));
