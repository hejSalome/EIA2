...
(function (aufgabe8z_inheritance) {
    ...
    aufgabe8z_inheritance.createBackground = createBackground;
    function drawFlowerfield() {
        for (let i = 0; i < 30; i++) {
            let ff = new aufgabe8z_inheritance.FlowerData();
            aufgabe8z_inheritance.flowers[i] = ff;
            console.log(ff);
        }
    }
    function drawSky(_x, _y) {
        ...
        aufgabe8z_inheritance.crc2.fillRect(_x, _y, aufgabe8z_inheritance.canvas.width, 175);
